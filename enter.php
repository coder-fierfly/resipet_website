  ...
  if (
    ...
    if ($ch_log[0] == 't') {
      ...
      if ($ch_block[0] == 't' && $ch_soft_del[0] == 't') {
        ...
        if ($ch_enter[0] == 'f') {
          echo "<script>alert(\"Превышено количество попыток входа\");</script>";
        } else {
          // session_start();
          if ($row[0] == 't') {
            ...
            echo "<script>alert(\"Проверьте пароль\");</script>";
          }
        }
      }
    } else {
      echo "<script>alert(\"Пользователь с таким логином не существует\");</script>";
    }
  }
}
?>
      ...
      <div class="u-form u-form-1">
        <form action="" method="POST" style="padding: 10px">
          <div class="u-form-group u-form-name u-label-none">
            ...
            <input type="text" maxlength="30" placeholder="Введите логин" id="user_log" name="user_log" class="u-input u-input-rectangle" required="">
          </div>
          <br>
          <div class="u-form-group u-label-none u-form-group-2">
            <label for="pwd" class="u-label"></label>
            <input type="password" maxlength="30" placeholder="Введите пароль" id="pwd" name="pwd" class="u-input u-input-rectangle">
          </div>
          <br>
